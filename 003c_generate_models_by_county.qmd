...
## mod_mixed_gam_v2 fixed and interaction

```{r}

p_fixed_mixed_gam_v2 <- ggplot(mod_mixed_gam_v2_fixed,aes(x=value, y=term,xmin=lower_2.5,xmax=upper_97.5,fill=swingto,colour=swingto)) + 
  geom_point(shape=21, size=3) + 
  geom_errorbar() + 
  scale_fill_manual(breaks = c("Conservative", "Labour"),
                    values = c("darkblue", "firebrick4")) + 
...
ggarrange(p_fixed_mixed_gam_v2,dorl_mod_mixed_gam_v2_p2, ncol = 2, widths = c(1,1.3))
...
temp_pie_county2<-st_coordinates(st_centroid(temp_pie_county1))
temp_pie_county3<-cbind(temp_pie_county1,temp_pie_county2)

county_pieglyph <- ggplot() + 
  geom_sf(data=regions, fill="gray99", colour="black", linewidth=1) + 
  geom_sf(data=temp_pie_county3,fill=NA) + 
  geom_pie_glyph(data=temp_pie_county3,aes(x=X,y=Y),slices=c("con_17","con_up","lab_up","lab_19","ld_19","pc_19"),
                 radius=0.7,colour="black") +
  scale_fill_manual(values = c("#A1B1F9","darkblue","darkred","#F9A1A4","yellow","darkgreen")) + 
  geom_sf_label_repel(data=temp_pie_county3,aes(label=county),size=1.6, colour="black", alpha=0.8) + 
  coord_sf(datum=NA) + 
  labs(fill = "Voteshare",
       title = "Counties") + 
  theme_bw() + 
...
## Checking assumptions of mixed model

```{r, fig.width=12, fig.height=6}

performance::check_model(mod_mixed_lmer_correl,check="reqq")

reg_county <- df |> 
  st_drop_geometry() |> 
  select(region,county) |> 
  unique()
mod_mixed_lmer_rand_withregion <- mod_mixed_lmer_rand |> 
  left_join(reg_county, by = c("level"="county"))

ggplot() + 
  stat_qq(data=mod_mixed_lmer_rand_withregion, aes(sample = estimate, colour=region), size=2) + 
  stat_qq_line(data=mod_mixed_lmer_rand_withregion, aes(sample = estimate)) + 
  scale_colour_carto_d(palette = "Pastel", direction = 1) + 
...
pre2r <- ggplot(ran_reg_sf) + 
  geom_sf(aes(fill=degree_educated)) +
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "degree_educated") + 
  theme_bw() + 
  theme(legend.position = "bottom")

pre3r <- ggplot(ran_reg_sf) + 
  geom_sf(aes(fill=younger_adults)) +
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "younger_adults") + 
  theme_bw() + 
  theme(legend.position = "bottom")

pre4r <- ggplot(ran_reg_sf) + 
  geom_sf(aes(fill=health_not_good)) +
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "health_not_good") + 
  theme_bw() + 
  theme(legend.position = "bottom")

pre5r <- ggplot(ran_reg_sf) + 
  geom_sf(aes(fill=white)) +
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "white") + 
  theme_bw() + 
...
pre_squarer <- ggarrange(pre2r,pre3r,pre4r,pre5r,nrow = 2, ncol = 2)

fixed_lmer <- ggarrange(pre1r,pre_squarer,nrow = 1, ncol = 2, widths = c(1,1.3))
...
pre1 <- ggplot() + 
  geom_sf(data=re_df1, aes(fill=intercept)) + 
...
pre2 <- ggplot() + 
  geom_sf(data=re_df1, aes(fill=degree_educated)) +
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "degree_educated") + 
  theme_bw() + 
...
pre3 <- ggplot() + 
  geom_sf(data=re_df1, aes(fill=younger_adults)) +
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "younger_adults") + 
  theme_bw() + 
...
pre4 <- ggplot() + 
  geom_sf(data=re_df1, aes(fill=health_not_good)) +
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "health_not_good") + 
  theme_bw() + 
...
pre5 <- ggplot() + 
  geom_sf(data=re_df1, aes(fill=white)) +
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "white") + 
  theme_bw() + 
...
pre_square <- ggarrange(pre2,pre3,pre4,pre5,nrow = 2, ncol = 2)

random_lmer <- ggarrange(pre1,pre_square,nrow = 1, ncol = 2, widths = c(1,1.3))
...
tot_eff <- re_df1 |> 
  mutate(f_intercept = rep(fix_nested[1,2], nrow(re_df1)),
         ...
         tot_intercept = intercept+f_intercept,
         tot_degree_educated = degree_educated+f_degree_educated,
         tot_younger_adults = younger_adults+f_younger_adults,
         tot_health_not_good = health_not_good+f_health_not_good,
         tot_white = white+f_white)

tot1 <- ggplot() + 
  geom_sf(data=tot_eff, aes(fill=tot_intercept)) + 
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "intercept") + 
  theme_bw() + 
...
tot2 <- ggplot() + 
  geom_sf(data=tot_eff, aes(fill=tot_degree_educated)) +
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "degree_educated") + 
  theme_bw() + 
...
tot3 <- ggplot() + 
  geom_sf(data=tot_eff, aes(fill=tot_younger_adults)) +
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "younger_adults") + 
  theme_bw() + 
...
tot4 <- ggplot() + 
  geom_sf(data=tot_eff, aes(fill=tot_health_not_good)) +
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "health_not_good") + 
  theme_bw() + 
...
tot5 <- ggplot() + 
  geom_sf(data=tot_eff, aes(fill=tot_white)) +
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "white") + 
  theme_bw() + 
...
tot_square <- ggarrange(tot2,tot3,tot4,tot5,nrow = 2, ncol = 2)

tot_lmer <- ggarrange(tot1,tot_square,nrow = 1, ncol = 2, widths = c(1,1.3))
...
pre1r <- ggplot(ran_reg_corexp_sf) + 
  geom_sf(aes(fill=intercept)) +
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "intercept") + 
  theme_bw() + 
...
pre2r <- ggplot(ran_reg_corexp_sf) + 
  geom_sf(aes(fill=degree_educated)) +
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "degree_educated") + 
  theme_bw() + 
...
pre3r <- ggplot(ran_reg_corexp_sf) + 
  geom_sf(aes(fill=younger_adults)) +
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "younger_adults") + 
  theme_bw() + 
...
pre4r <- ggplot(ran_reg_corexp_sf) + 
  geom_sf(aes(fill=health_not_good)) +
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "health_not_good") + 
  theme_bw() + 
...
pre5r <- ggplot(ran_reg_corexp_sf) + 
  geom_sf(aes(fill=white)) +
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  labs(subtitle = "white") + 
  theme_bw() + 
...
pre_squarer_corex <- ggarrange(pre2r,pre3r,pre4r,pre5r,nrow = 2, ncol = 2)

fixed_corexp <- ggarrange(pre1r,pre_squarer_corex,nrow = 1, ncol = 2, widths = c(1,1.3))
...
pre_square_corexp <- ggarrange(pre2,pre3,pre4,pre5,nrow = 2, ncol = 2)

random_corexp <- ggarrange(pre1,pre_square_corexp,nrow = 1, ncol = 2, widths = c(1,1.3))
...
tot_eff <- re_df1 |> 
  mutate(f_intercept = rep(fix_nested_corexp[1,2], nrow(re_df1)),
         f_degree_educated = rep(fix_nested_corexp[2,2], nrow(re_df1)),
         f_younger_adults = rep(fix_nested_corexp[3,2], nrow(re_df1)),
         f_health_not_good = rep(fix_nested_corexp[4,2], nrow(re_df1)),
         f_white = rep(fix_nested_corexp[5,2], nrow(re_df1)),
         tot_intercept = intercept+f_intercept,
         tot_degree_educated = degree_educated+f_degree_educated,
         tot_younger_adults = younger_adults+f_younger_adults,
         tot_health_not_good = health_not_good+f_health_not_good,
...
tot_corexp <- ggarrange(tot1,tot_square,nrow = 1, ncol = 2, widths = c(1,1.3))
...
## 2 models rand eff side by side
...
## 3 models total eff side by side
