---
title: "A multilevel spatial model to assess the relationship between local identity and swing to the Conservative Party in the 2019 UK general election"
---
...
This section takes a long time to run as it fits many models. The chunks have been set as eval=FALSE and the table output is shown below.
...
mod1 <- read_rds(here("mod1.rds")) # varing coeffs
mod2 <- read_rds(here("mod2.rds")) # varying ints
mod3 <- read_rds(here("mod3.rds")) # both
...
The optimal model and k value are as described below:
...
```{r, fig.width=6.5, fig.height=8, out.width="100%"}
