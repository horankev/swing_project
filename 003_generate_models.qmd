...
## Where are the large residuals? (magnitude > 2)
...
df$res_mod_lm <-mod_lm$residuals
pp1<- ggplot() + 
  geom_sf(data=df |> 
            filter(res_mod_lm<(-2) | res_mod_lm>2), aes(fill=res), lwd=0.1) + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
...
df$res_mod_lm_mrf <-mod_lm_mrf$residuals
pp2<- ggplot() + 
  geom_sf(data=df |> 
            filter(res_mod_lm_mrf<(-2) | res_mod_lm_mrf>2), aes(fill=res), lwd=0.1) + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  coord_sf(datum=NA) + 
  labs(fill="Residuals",
...
df$res_mod_nlme_corExp <-residuals(mod_nlme_corExp)
pp3<- ggplot() + 
  geom_sf(data=df |> 
            filter(res_mod_nlme_corExp<(-2) | res_mod_nlme_corExp>2), aes(fill=res), lwd=0.1) + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  coord_sf(datum=NA) + 
  labs(fill="Residuals",
       title = "res_mod_nlme_corExp") + 
  theme_bw()

df$res_mod_mixed_gam <-mod_mixed_gam$residuals
pp4<- ggplot() + 
  geom_sf(data=df |> 
            filter(res_mod_mixed_gam<(-2) | res_mod_mixed_gam>2), aes(fill=res), lwd=0.1) + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  coord_sf(datum=NA) + 
  labs(fill="Residuals",
       title = "res_mod_mixed_gam") + 
  theme_bw()

df$res_mod_mixed_gam_v1 <-mod_mixed_gam_v1$residuals
pp5<- ggplot() + 
  geom_sf(data=df |> 
            filter(res_mod_mixed_gam_v1<(-2) | res_mod_mixed_gam_v1>2), aes(fill=res), lwd=0.1) + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  coord_sf(datum=NA) + 
  labs(fill="Residuals",
       title = "res_mod_mixed_gam_v1") + 
  theme_bw()

df$res_mod_mixed_gam_v2 <-mod_mixed_gam_v2$residuals
pp6<- ggplot() + 
  geom_sf(data=df |> 
            filter(res_mod_mixed_gam_v2<(-2) | res_mod_mixed_gam_v2>2), aes(fill=res), lwd=0.1) + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint = 0) + 
  geom_sf(data=regions, fill=NA, linewidth=0.5, colour="black") + 
  coord_sf(datum=NA) + 
  labs(fill="Residuals",
       title = "res_mod_mixed_gam_v2") + 
  theme_bw()


ggarrange(pp1,pp2,pp3,pp4,pp5,pp6, ncol = 2, nrow = 3, common.legend = TRUE)
```
