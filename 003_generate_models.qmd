...
## Do we need to model the spatial relationship between the regions for this dataset?

```{r}

###

anova(mod_lm,mod_lm_mrf)
...
## Separate Moran's plots by region for nlme_CorExp
