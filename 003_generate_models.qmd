...
dorl_mod_mixed_lmer_p2 <- ggplot() + 
  ...
  geom_sf_text(data=counties_dorling,aes(label=reg_abbrev)) + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint=0) + 
...
dorl_mod_mixed_gam_v2_p2 <- ggplot() + 
  geom_sf(data=counties_dorling,aes(fill=effect,colour=signifigant,label=region), linewidth=0.5) + 
  geom_sf_text(data=counties_dorling,aes(label=reg_abbrev)) + 
  scale_fill_gradient2(low="darkred",mid="white",high="darkblue",midpoint=0) + 
  scale_colour_manual(values = c("gray90","black")) + 
  coord_sf(datum=NA) + 
...
ggarrange(p_fixed_lmer,dorl_mod_mixed_lmer_p2, ncol = 2)
...
ggarrange(p_fixed_gam_v1,dorl_mod_mixed_gam_v1_p2, pgeo1_fixed_gam_v1, pgeo2_fixed_gam_v1, ncol = 2, nrow=2)
...
ggarrange(p_fixed_gam_v2,dorl_mod_mixed_gam_v2_p2, ncol = 2)
